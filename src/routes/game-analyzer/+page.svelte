    ...
    <div class="right-column w-full md:w-1/2 flex flex-col gap-6">
      <div class="pgn-input-section">
        ...
        <button 
          ...
          class="hover:cursor-pointermt-2 px-6 py-2 bg-sky-600 hover:bg-sky-700 text-white font-semibold rounded-md transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed w-full"
        >
